...
class MLIPInterfaceSearch(BaseInterfaceSearch):
    ...
    def __init__(
        ...
        surface_matching_kwargs = {"mlip": mlip,
                                   "model_name": model_name,
                                   "device": device, }
        self._filter_on_charge = filter_on_charge
        super().__init__(
            surface_matching_module=MLIPSurfaceMatcher,
            surface_energy_module=MLIPSurfaceEnergy,
